print_hex:								; function to print hex values
	.prepare:
		push bp
		mov bp, sp
	...
	.print_hex_done:
		push HEX_OUT   					; print the string pushed to the stack
		call print
		pop ax							; make sure there is no trash in the stack so it wont bother popa
